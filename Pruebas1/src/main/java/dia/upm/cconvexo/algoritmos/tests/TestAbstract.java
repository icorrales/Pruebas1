...
public abstract class TestAbstract extends TestCase {
	...
	{
		assertEquals(cierreConvexo.size(), cierreConvexoReal20.size());
		for (Iterator iterator = cierreConvexo.iterator(); iterator.hasNext();) {
			Punto punto = (Punto) iterator.next();
	...
	protected void compruebaCierreConvexoPorAristas(List<Arista> conjuntoConvexo, List<Punto> cierreConvexo) {
		// TODO Auto-generated method stub
