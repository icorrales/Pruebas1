package com.example.pruebas1.test;
...
public abstract class TestAbstract extends InstrumentationTestCase {
	...
	protected void imprimeCierresConvexos(List<Punto> cierreConvexo, List<Arista> aristas) {
		// TODO Auto-generated method stub
        Log.d("TestAbstract","Cierre Real:" + cierreConvexo.toString());
        Log.d("TestAbstract", "Aristas Obtenidas:" + aristas.toString());
